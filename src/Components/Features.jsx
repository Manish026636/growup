    ...
    <div>
      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative"> What's in store for you</span>
          </span>{' '}
      ...
      <div className="grid gap-8 row-gap-10 lg:grid-cols-3">
        <div className="max-w-md sm:mx-auto sm:text-center">
          ...
          <h6 className="mb-3 text-xl font-bold leading-5">Build Connections</h6>
        ...
        <div className="max-w-md sm:mx-auto sm:text-center">
          ...
          <h6 className="mb-3 text-xl font-bold leading-5">Explore Internships</h6>
          <p className="mb-3 text-sm text-gray-900">
        ...
        <div className="max-w-md sm:mx-auto sm:text-center">
          ...
          <h6 className="mb-3 text-xl font-bold leading-5">Explore Jobs</h6>
          <p className="mb-3 text-sm text-gray-900">
        ...
        <div className="max-w-md sm:mx-auto sm:text-center">
          ...
          <h6 className="mb-3 text-xl font-bold leading-5">Gain Mentorship</h6>
          <p className="mb-3 text-sm text-gray-900">
        ...
        <div className="max-w-md sm:mx-auto sm:text-center">
          ...
          <h6 className="mb-3 text-xl font-bold leading-5">Events</h6>
          <p className="mb-3 text-sm text-gray-900">
          Receive guidance from experienced mentors to navigate academic and career challenges effectively
          </p>
