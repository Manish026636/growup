...
const Navbar = () => {
  ...
  return (
    <header className="pb-6 bg-gray-50 lg:pb-0">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <nav className="flex items-center justify-between h-16 lg:h-20">
          <div className="flex-shrink-0">
            <a href="#" title="" className="flex">
              <img
                className="w-auto lg:mt-0 md:mt-10 h-6 lg:h-6"
                src="gub.png"
                alt=""
              />
            </a>
        ...
        >
          <div className="flow-root">
            <div className="flex flex-col px-6 -my-2 space-y-1">
              ...
              <a href="#" title="" className="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">About us</a>
            </div>
          </div>
